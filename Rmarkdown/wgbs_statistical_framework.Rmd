...
Almost all the samples with significant intermediate methylation are either somatic cell lines --- _ADS_, _ADS-adipose_, _FF_, _IMR90\_r1_ and _IMR90\_r2_ from the Lister dataset; _IMR90\_cell\_line_ from the Ziller dataset --- or cancer cells lines and tissue --- _HepG2\_cell\_line_, _Colon\_Tumor\_Primary_ and _Colon\_Primary\_Normal_ from the Ziller dataset. Aside from the aforementioned _E16.5\_male\_1_, the _E6.5\_epiblast\_1_ sample from the Seisenberger dataset also displays greater levels of intermediate methylation. This sample was also created by pooling DNA from multiple mice, which may explain the extra variability in the $\beta$-value distribution.
...
The explanation for the somatic cell lines is less clear. Notably, all of the 12 EPISCOPE samples, which are somatic tissue samples rather than cell lines, have relatively low levels of intermediate methylation. Likewise, the various frontal cortex samples in the Ziller dataset --- _Frontal\_cortex\_normal\_1_, _Frontal\_cortex\_normal\_2_, _Frontal\_cortex\_AD\_1_ and _Frontal\_cortex\_AD\_2_ --- which includes both 'normal' and Alzheimer's samples, have very low levels of intermediate methylation. This raises the question as to whether the widespread partial methylation observed in the somatic samples from the Lister dataset is in fact a feature of somatic cell lines rather than somatic cells _per se_. Naively, a cell line is a 'pure' cell population, however, the DNA methylation data clearly reveal widespread differences between cells in these populations.
