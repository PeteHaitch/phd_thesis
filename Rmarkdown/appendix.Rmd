...
\section{Equivalence of tests to identify DMCs in a one-group experiment}\label{app:one_group_equivalence}
...
\subsection{Computational equiavelence}
...
\section{Estimate of number of CpGs used by \citet{Lacey:2013iy}}\label{app:lacey}
