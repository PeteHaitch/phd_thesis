...
## CpGs are underrepresented in the human genome

This short R script demonstrates that CpGs are underrepresented in the human reference genome (build hg19).
...
ggplot(x, aes(x = Dinucleotide, y = Observed / Expected)) + 
  geom_point(size = 5) + ylim(c(0, 1.5)) + 
