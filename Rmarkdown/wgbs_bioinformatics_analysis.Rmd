...
\texttt{methclone} & \cite{Li:2014ei}                       & Bismark BAM files                                  & No, although example uses eRRBS  & \textbf{TODO: Try installing. Suspect you can't get actual methylation calls.} \\
\texttt{methpat}  & \url{https://github.com/bjpop/methpat} & Output of \texttt{bismark\_methylation\_extractor} & Yes (amplicons)                  &                                                                                  \\
\texttt{DMEAS}     & \cite{He:2013cj}                       & Output of \texttt{bismark\_methylation\_extractor} &                                  & Windows operating system only. Perl code only available as PDF file.             \\ \bottomrule
\end{tabular}
\caption{My caption}
...
__TODO: Show example of `methtuple` output__
