...
Almost all downstream analyses are reference-based (see Section \ref{sec:methylation_calling}), so it is desirable to know how these methods perform with respect to the relevant reference genome, not a simulated genome in which the location of methylation loci vary from simulation to simulation.
