...
- _SA_: Subcutaneous adidose tissue, which is fat found just below the skin. Unlike visceral fat, "subcutaneous fat is not related to many of the classic obesity-related pathologies, such as heart disease, cancer, and stroke" (__TODO: Get better reference than wikipedia__).
- _VA_: Visceral adipose tissue, which is located inside the abdominal cavity, packed between the organs (stomach, liver, intestines, kidneys, etc.) (__TODO: Get better reference than wikipedia__).
...
E6.5\_epiblast\_1 & Epiblast                   & PE         & $101$ bp    & $13\times$     \\
E16.5\_male\_1    & Male progenitor germ cells & PE         & $150$ bp    & $12\times$     \\ \bottomrule
\end{tabulary}
