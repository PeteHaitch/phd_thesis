...
The methylC-seq libraries from the \cite{Lister:2011kg} include some created by the authors and some published by other groups (see Table \ref{tab:Lister_dataset}). These samples include cell lines from differentiated cell lines, embryonic stem cell lines, pluripotent stem cell lines and _in vitro_ differentiated from pluripotent stem cells. There are no replicates for any of the \cite{Lister:2011kg} samples.
