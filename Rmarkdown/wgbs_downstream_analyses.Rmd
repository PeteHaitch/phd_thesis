...
[^bioc]: `MethylationTuples` has not yet been submitted to Bioconductor but its development is being published to [bioconductor.org/packages/GenomicTupless](bioconductor.org/packages/GenomicTuples).
