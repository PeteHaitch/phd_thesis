...
- [x] Find a `wordcount` function for LaTeX or markdown files.
  - Use `texcount` ([http://stackoverflow.com/questions/2974954/correct-word-count-of-a-latex-document](http://stackoverflow.com/questions/2974954/correct-word-count-of-a-latex-document)).
...
- [x] Complete progress review
- [x] Organise progress review meeting __URGENT__
  - [x] Emailed Terry
  - [x] Emailed Peter
  - [x] Emailed Gordon
...
- [x] __URGENT:__ Consult notes from meeting with Lynne Hartley
