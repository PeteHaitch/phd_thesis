...
- Read up on what happens with the MH estimator when the common odds ratio assumption is invalid.
  - Is there a better estimator in this setting? The Miettennen estimator?
...
- Compute MH estimates (and standard errors) of within-fragment co-methylation for different stratification strategies.
  - Stratify by IPD
