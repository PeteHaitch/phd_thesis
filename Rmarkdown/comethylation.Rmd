...
We now explore what happens when the odds ratio is heterogeneous across the $K$ tables. __UP TO HERE__


\subsection{Summary}

We conclude that we cannot estimate within-fragment co-methylation at individual 2-tuples using $\psi_{0.5}$ unless ultra-deep[^ultra-high_depth] sequencing is used ($d > 10000 \times$). The $\widehat{\theta_{0.5}}$ at typical sequencing depths ($d \approx 30$) are highly biased.
