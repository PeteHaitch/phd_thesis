...
__TODO: Break out review of co-methylation into its own chapter.__
...
__TODO: Incorporate material in "Correlations" section of `a_statistical_model_of_methylC-seq.md`.__
...
\subsection{Correlations of aggregate measurements of methylation}
...
\subsection{Within-fragment co-methylation analyses}
...
\subsection{Between-sample co-methylation}
...
\subsection{Exploiting co-methylation in analyses of differential methylation}
