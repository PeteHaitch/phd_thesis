...
The simplest estimator of the odds ratio is the unconditional maximum likelihood estimator, $\widehat{\psi_{U}} = \frac{n_{11} n_{22}}{n_{12} n_{21}}$.

- Go through the various estimators, their pros and cons.
   - Conditional maximum likelihood estimator
- Explain the advantage of the "0.5-adjusted" unconditional estimator.
