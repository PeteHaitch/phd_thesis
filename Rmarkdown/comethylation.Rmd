...
I define co-methylation is the dependence of DNA methylation at different methylation loci within a sample. In other words, it is the dependence or correlation structure of DNA methylation data within a sample. This is slightly different to \citeauthor{Schatz:2004cha} who defined it as, "the presence of methylation over a stretch of neighboring CpG positions" and more in line with \citeauthor{Eckhardt:2006gh} who defined it as, "the relationship between the degree of methylation over distance".
...
Most analyses of co-methylation have been based on aggregate measurements of methylation, such as $\beta$-values \citep{Eckhardt:2006gh, Cokus:2008fc, Li:2010fb, Lyko:2010dr, Hebestreit:2013ko, Lacey:2013iy, Liu:dy}. This is true of studies using both microarray data, where only these type of measurements are available, and sequencing data, where base-resolution measurements are also available. Very often the exact analysis is not well-described but it can generally be thought of as studying the autocorrelation of the $\beta$-values along the genome.
...
* Other definitions/methods
  ...
  * "vertical" correlations of \citet{Capra:2014uh}
